...
def field_core(pars, presets):
    ...
    loc_pulse.temporal_bound_ft(bnd.temporal_gauss, pars.t, presets['enable_shift'], *(pars.tp_max, pars.omega0))
...
def set_default_inputs():
    default_inputs = {}
    default_inputs['lambda0'] = 0.1# * 10**(-4) # microns# #10**(-4) cantimeters #
    default_inputs['w0'] = 20 #[lambda0]
